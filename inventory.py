...
class Application(tk.Frame):
    def __init__(self, master):
        ...
        self.master = master
        master.title('Super Market Inventory')
        # Width height
    ...
    def create_widgets(self):
        ...
        self.part_label = tk.Label(
            self.master, text='Commodity Name', font=('bold', 14), pady=20)
        ...
        self.customer_label = tk.Label(
            self.master, text='Commodity Number', font=('bold', 14))
        ...
        self.retailer_label = tk.Label(
            self.master, text='Amount in Stock', font=('bold', 14))
        ...
        self.add_btn = tk.Button(
            self.master, text="Add Goods", width=12, command=self.add_item)
        self.add_btn.grid(row=2, column=0, pady=20)

        self.remove_btn = tk.Button(
            self.master, text="Remove Goods", width=12, command=self.remove_item)
        self.remove_btn.grid(row=2, column=1)

        self.update_btn = tk.Button(
            self.master, text="Update Goods", width=12, command=self.update_item)
        self.update_btn.grid(row=2, column=2)

        self.exit_btn = tk.Button(
            self.master, text="Clear Text Fields", width=12, command=self.clear_text)
